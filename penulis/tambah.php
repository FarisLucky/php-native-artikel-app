    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 pt-3">
          <h5 class="text-center">Ayo tambahkan artikelmu ,Sekarang !</h5>
        </div>
      </div>
      <div class="row">
        <div class="co-sm-12">
          <a href="<?= BASE_URL ?>penulis/kelolaartikel.php" class="btn btn-dark btn-sm">kembali</a>
        </div>
      </div>
      <div class="row justify-content-center">
                ...
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="artikel" class="form-control" cols="30" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                      <button type="submit" name="tambah_artikel" class="btn btn-sm btn-primary mx-3 ">Simpan</button>
