...
$artikel = selectWhere($conn,'tb_artikel',['id'=>$_GET['id']]);
 ?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-lg-8 d-block">
          <div class="row d-flex">
            ...
            <div class="col-md topper d-flex align-items-center justify-content-end">
              ...
              <?php } else { ?>
              <p class="mb-0">
                <a href="<?= BASE_URL.'publicLogout.php' ?>"
                  class="btn py-2 px-3 btn-primary d-flex align-items-center justify-content-center">
                  <span>Logout</span>
                </a>
              </p>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 pt-3">
          <h5 class="text-center">Ayo Ubah artikelmu ,Sekarang !</h5>
        </div>
      </div>
      <div class="row">
        <div class="co-sm-12">
          <a href="<?= BASE_URL ?>penulis/kelolaartikel.php" class="btn btn-dark btn-sm float-right">kembali</a>
        </div>
      </div>
      <?php
      ...
      <div class="row justify-content-center">
        <div class="col-sm-8 p-4 pt-2">
          <div class="card">
            <div class="card-body">
              <form action="<?= BASE_URL ?>core/core_artikel.php" method="post">
                <input type="hidden" name="id" value="<?= $data['id'] ?>">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Judul Artikel</label>
                      <input type="text" name="judul" class="form-control" value="<?= $data['judul_artikel'] ?>">
                    </div>
                    <div class="form-group">
                      <label>Isi Artikel</label>
                      <textarea name="artikel" class="form-control" cols="30"
                        rows="10"><?= $data['isi_artikel'] ?></textarea>
                    </div>
                    <div class="form-group">
                      <button type="submit" name="ubah_artikel" class="btn btn-sm btn-primary mx-3 ">Simpan</button>
                      <button type="reset" class="btn btn-sm btn-secondary pl-2">Reset</button>
                    </div>
                  </div>
                </div>
              </form>
