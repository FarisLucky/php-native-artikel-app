    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 pt-3">
          <h5 class="text-center"><?= $data['judul_artikel'] ?></h5>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-sm-12 p-4 pt-2">
          <div class="container">
            <div class="card">
              ...
              <form action="<?= BASE_URL ?>core/core_komentar.php">
                <div class="card-footer">
                  ...
                  <div class="form-group">
                    <input type="text" name="email" class="form-control form-control-sm" placeholder="Masukkan Email">
                  </div>
