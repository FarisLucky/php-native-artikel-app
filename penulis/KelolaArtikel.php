...
$artikel = selectWhere($conn,'tb_artikel',['id_penulis'=>$_SESSION['id_penulis']]);
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 pt-3">
          <h5 class="text-center">Kelola Artikel !</h5>
        </div>
      </div>
      <div class="row justify-content-center">
        <div class="col-sm-12 p-4 pt-2">
          <div class="row mb-3">
            <div class="col-sm-12">
              <a href="<?= BASE_URL.'penulis/tambah.php' ?>" class="btn btn-sm btn-success float-right px-2">Tambah</a>
            </div>
          </div>
          <form action="<?= BASE_URL ?>core/core_artikel.php">
            <div class="row">
              <div class="col-sm-12 table-responsive">
                <table class="table table-sm table-bordered table-hover table-striped" id="tbl_artikel">
                  <thead>
                    <th>No</th>
                    <th>Judul</th>
                    <th>Isi Artikel</th>
                  ...
                  <tbody>
                    <?php $no= 1; while ($data = mysqli_fetch_assoc($artikel)) { ?>
                    <tr>
                      <td><?= $no ?></td>
                      ...
                      <td><?= $data['tanggal'] ?></td>
                      <td>
                        <a href="<?= BASE_URL.'penulis/ubah.php?id='.$data['id'] ?>"
                          class="btn btn-sm btn-info">Ubah</a>
                        <button onclick="deleted('<?= $data['id'] ?>')" class="btn btn-sm btn-danger">Hapus</>
                      </td>
                    </tr>
                    <?php $no++; } ?>
                  </tbody>
  ...
  function deleted(id) {
    if (confirm("Apakah ingin dihapus ?")) {
      window.location = <?= BASE_URL.'core/core_artikel.php?hapus=' ?>id;
    }
  }
  </script>
