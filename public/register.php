    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 pt-3">
          <h5 class="text-center">Ayo Daftar Menjadi Penulis !</h5>
        </div>
      </div>
      <div class="row justify-content-center">
              ...
              <form action="<?= BASE_URL ?>core/core_registrasi.php" method="POST">
                <div class="row">
                  <div class="col-sm-12">
                    ...
                    <div class="form-group">
                      <button type="submit" name="register" class="btn btn-primary pl-2">Simpan</button>
                    </div>
                    <div class="form-group">
                      <a href="<?= BASE_URL ?>public/login.php" class="float-right">login ?</a>
                    </div>
                  </div>
                </div>
              </form>
